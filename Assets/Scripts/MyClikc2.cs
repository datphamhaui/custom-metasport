...
public class MyClikc2 : MonoBehaviour
{
	...
	void Start () {
		...
		player = Instantiate(myPrefab[1], new Vector3(1f, 1f, -2.0f), Quaternion.identity);
    ...
    void ShowNextCharacter(){
		...
		player = Instantiate(myPrefab[x], new Vector3(1f, 1f, -2.0f), Quaternion.identity);
